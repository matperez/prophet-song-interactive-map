...
Для создания графа знаний из литературного произведения используйте правила, описанные в [EXTRACTION_RULES.md](EXTRACTION_RULES.md). Этот документ содержит детальные инструкции для AI-агента по извлечению персонажей, событий и связей из текста книги.
